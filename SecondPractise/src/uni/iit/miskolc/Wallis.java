...
public class Wallis {
	...
	public static void main(String[] args) {
		...
		for (double i = 1; i < 10000; i++) {
			...
			System.out.println("A pi értéke Wallis-formulával: " + pi*2);
		pi=0.0;
		...
		for (int i = 0; i < 10000; i++) {
			...
			System.out.println("A pi értéke Leibniz-formulával: " + pi*4);
			...
			*/
			...
			System.out.println("Linear Search result :" + linearSearch(45, array));
